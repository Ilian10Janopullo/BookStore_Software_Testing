...
public class PermissionCombo6 extends BorderPane {
    ...
    public PermissionCombo6(Stage stage) {
        ...
        HBox hBox = new HBox();
        hBox.getChildren().addAll(vBox1, vBox2, vBox5);
        hBox.setSpacing(100);
        this.setCenter(hBox);
        this.setBottom(logout);
        setMargin(hBox, new Insets(0, 20, 0, 355));
