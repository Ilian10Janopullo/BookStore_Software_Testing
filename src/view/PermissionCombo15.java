...
public class PermissionCombo15 extends BorderPane {
    ...
    public PermissionCombo15(Stage stage) {
        ...
        vBox3.getChildren().addAll(checkU, checkUsers);
        ...
        setMargin(hBox, new Insets(0, 20, 0, 85));
